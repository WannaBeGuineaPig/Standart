...
public partial class ShoesContext : DbContext
{
    ...
    public static ShoesContext Context
    {
        get
        {
            if (_context == null)
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=localhost;user=root;password=root;database=shoes", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.39-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Item>(entity =>
        {
            ...
            entity.HasOne(d => d.IdManafacturerNavigation).WithMany(p => p.Items)
            ...
            entity.HasOne(d => d.IdTypeNavigation).WithMany(p => p.Items)
